...
{
    internal class X509CertStoreFinder : IPregeneratedCertificateSource, IDisposable
    {
        private readonly X509Store _store;
        private readonly ILogger<X509CertStoreFinder> _logger;

        public bool AllowInvalidCerts { get; set; }

        public X509CertStoreFinder(ILogger<X509CertStoreFinder> logger)
        {
